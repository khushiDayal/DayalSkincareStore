          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              ...
              >
                ...
                {cart.length > 0 && (<span className="absolute -top-2 -left-2 bg-[#cf7b7d] text-[#ffffff] rounded-full px-2 py-0.5 text-xs group-hover:bg-[#EFB6C8] transition-duration-300 ease-in-out">
                  {cart.length}
                </span>)}
              </Link>
            )}
            ...
            {isAdmin && (
              <Link
                className="bg-[#f3d1b1] hover:bg-[#cca271e5] text-[#55320b] px-3 py-1 rounded-md font-medium transition duration-300 ease-in-out flex items-center"
                to={"/secret-dashboard"}
              >
            ...
            {user ? (
              <button className="bg-[#f3d1b1] hover:bg-[#cca271e5] text-[#55320b] py-2 px-4 
